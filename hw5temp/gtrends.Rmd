...
DISCLAIMER: This was created as part of a class project and should not be used as official health information.
```{r}

# see coronavirus search alone or compare to another query
radioButtons("view", "See the number of hits for the search term 'coronavirus' ",
                       c("by itself" = "1",
                         "compared to: " = "2"),
                 selected = "2")
